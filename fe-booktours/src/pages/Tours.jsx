...
const Tours = () => {
  ...
  useEffect(() => {
    document.title = `Du lịch ${
      objectQuery.region ? objectQuery.region : ""
    }`;
    window.scrollTo(0, 0);
  }, []);
        ...
        <div className="flex bg-cover saturate-50 bg-center h-56 my-5 bg-[url('/src/assets/img/destinations/2/4.png')]">
          <div className="m-auto grid">
            ...
            <p className="mx-auto w-2/3 line-clamp-4 text-white md:text-lg text-center">
              Miền Bắc Việt Nam, nằm ở phía bắc của đất nước, là vùng đất đa
              dạng văn hóa, phong cảnh hùng vĩ và lịch sử lâu đời. Nổi bật với
              thủ đô Hà Nội cổ kính, nơi lưu giữ nhiều di sản văn hóa như phố cổ
              Hà Nội, hồ Hoàn Kiếm và Văn Miếu - Quốc Tử Giám. Phía bắc Hà Nội
              là vùng núi cao Tây Bắc với thiên nhiên tuyệt đẹp, từ các thửa
              ruộng bậc thang kỳ vĩ ở Mù Cang Chải, Sa Pa, cho đến các đỉnh núi
              cao quanh năm mây phủ như Fansipan - nóc nhà Đông Dương.
            </p>
          </div>
        </div>
        <div>
                    ...
                    <div className="rounded-lg">
                      <div className="grid gap-3">
                        {tours?.length > 0 ? (
                          ...
                          <h1>
                            Hiện tại chưa có tour nào phù hợp với yêu cầu của
                            bạn
                          </h1>
                        )}
                      </div>
