...
const HotelCreate = (props) => {
  ...
  const handleCreate = async () => {
    ...
    try {
      const response = await HotelService.createDefaultHotel({
        hotelName: defaultHotel.hotelName,
        hotelStar: defaultHotel.hotelStar,
        location: locations[defaultHotel.locationIndex],
      });
                      ...
                      <div className="md:col-span-2">
                        ...
                        <div className="mt-1">
                          <select
                            ...
                            value={defaultHotel.locationIndex}
                            onChange={(e) => {
                              setDefaultHotel({
                                ...defaultHotel,
                                locationIndex: e.target.value,
                              });
                            }}
                          >
